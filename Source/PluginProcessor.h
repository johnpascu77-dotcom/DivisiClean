...
public:
    ...
    juce::String getEngineModeDisplayName() const;

    static juce::String engineModeToStorageString(EngineMode mode);
    static EngineMode engineModeFromStorageString(const juce::String& text);
...
private:
    ...
    std::atomic<int> selectedEngineMode { static_cast<int>(EngineMode::ChordWindow) };
